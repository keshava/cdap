...
import io.cdap.cdap.internal.app.runtime.distributed.launcher.TestLauncherTwillRunnerService;
...
//    bind(twillRunnerServiceKey).to(RemoteExecutionTwillRunnerService.class).in(Scopes.SINGLETON);
    bind(twillRunnerServiceKey).to(TestLauncherTwillRunnerService.class).in(Scopes.SINGLETON);
