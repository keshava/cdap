 ...
 *
 */
public class TestLauncherTwillConrtoller implements TwillController {

  private static final Logger LOG = LoggerFactory.getLogger(TestLauncherTwillConrtoller.class);

  private final RunId runId;
  private final CompletableFuture<TestLauncherTwillConrtoller> started;
  private final CompletableFuture<TestLauncherTwillConrtoller> completion;

  TestLauncherTwillConrtoller(RunId runId) {
    this.runId = runId;

    CompletableFuture<TestLauncherTwillConrtoller> completion = new CompletableFuture<>();
